        ...
        <div class="topnav-content">
            <div class="nav-left">
                <button class="back-btn" onclick="goBack()">
                    <img src="../Photos/back.png" alt="Back" class="nav-icon"> Back Home
                </button>
            ...
            <div class="nav-right">
                ...
                <button class="nav-btn logout-btn" title="Logout">
                    <img src="../Photos/logout.png" alt="Logout" class="nav-icon">
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="profile-card">
            ...
            <div class="cover-section">
                ...
                <button class="cover-btn" onclick="uploadCover()">
                    <img src="../Photos/camera.png" alt="Upload" class="btn-icon"> Upload Cover
                </button>
            </div>
            ...
            <div class="profile-header">
                    ...
                    <div class="profile-pic-section">
                        <div class="profile-pic">
                            ...
                            <button class="pic-btn" onclick="uploadProfilePic()">
                                <img src="../Photos/camera.png" alt="Upload" class="btn-icon">
                            </button>
                        </div>
                    </div>
                ...
                <div class="action-buttons">
                    <button class="btn btn-primary" onclick="editProfile()">
                        <img src="../Photos/edit.png" alt="Edit" class="btn-icon"> Edit Profile
                    </button>
                    <button class="btn" onclick="uploadPhotos()">
                        <img src="../Photos/photoup.png" alt="Photos" class="btn-icon"> Upload Photos
                    </button>
                    <button class="btn" onclick="uploadVideos()">
                        <img src="../Photos/videoup.png" alt="Videos" class="btn-icon"> Upload Videos
                    </button>
                    <button class="btn btn-live" onclick="goLive()">
                        <img src="../Photos/live.png" alt="Live" class="btn-icon"> Go Live
                    </button>
                </div>
            </div>
            ...
            <div class="contact-section">
                ...
                <div class="contact-grid">
                    <div class="contact-item">
                        <img src="../Photos/role.png" alt="Role" class="contact-icon">
                        <div>
                    ...
                    <div class="contact-item">
                        <img src="../Photos/location.png" alt="Location" class="contact-icon">
                        <div>
                    ...
                    <div class="contact-item">
                        <img src="../Photos/email.png" alt="Email" class="contact-icon">
                        <div>
                    ...
                    <div class="contact-item">
                        <img src="../Photos/phone.png" alt="Phone" class="contact-icon">
                        <div>
                    ...
                    <div class="post-card" data-type="photo">
                        <div class="post-image">
                            ...
                            <button class="delete-btn" onclick="deletePost(1)">
                                <img src="../Photos/delete.png" alt="Delete" class="delete-icon">
                            </button>
                        </div>
                        <div class="post-info">
                            <h4>Sunset View</h4>
